...
# What plays the sound. The one library this application links outright, and
# asked for as a pkg-config name rather than as a package so that whichever
# alsa-lib-devel the buildroot has answers for it.

...
/// How large the picture of a button is drawn, and so how tall the row is.
/// Public because the band the row sits in has to be checked against it — see
/// `draw::FOOT`.
pub const GLYPH: f32 = 28.0;
const GAP: f32 = 7.0;
const STEP: f32 = 22.0;
